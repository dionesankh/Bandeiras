...
CREATE OR REPLACE FUNCTION "public"."create_challenge_from_ranked_session"("p_ranked_session_id" "uuid", "p_idemp_key" "text") RETURNS "jsonb"
    LANGUAGE "plpgsql" SECURITY DEFINER
    SET "search_path" TO 'public', 'private', 'auth'
    AS $$
DECLARE
...
ALTER FUNCTION "public"."create_challenge_from_ranked_session"("p_ranked_session_id" "uuid", "p_idemp_key" "text") OWNER TO "postgres";
...
CREATE OR REPLACE FUNCTION "public"."get_public_profile"("p_target_user_id" "uuid") RETURNS "jsonb"
    LANGUAGE "plpgsql" SECURITY DEFINER
    SET "search_path" TO 'public', 'private', 'auth'
    AS $$
DECLARE
...
ALTER FUNCTION "public"."get_public_profile"("p_target_user_id" "uuid") OWNER TO "postgres";


CREATE OR REPLACE FUNCTION "public"."get_supporter_profile_details"("p_target_user_id" "uuid") RETURNS "jsonb"
    LANGUAGE "plpgsql" SECURITY DEFINER
    SET "search_path" TO 'public', 'private', 'auth'
    AS $$
DECLARE
...
ALTER FUNCTION "public"."get_supporter_profile_details"("p_target_user_id" "uuid") OWNER TO "postgres";
...
CREATE TABLE IF NOT EXISTS "private"."ranked_game_sessions" (
    ...
    "mode" "text" NOT NULL,
    "variation" "text" NOT NULL,
    "status" "public"."session_status_t" DEFAULT 'created'::"public"."session_status_t" NOT NULL,
    "expires_at" timestamp with time zone NOT NULL,
    "created_at" timestamp with time zone DEFAULT "now"() NOT NULL,
    "seed" "text",
    "algorithm_version" "text" DEFAULT 'server-sequence-v1'::"text" NOT NULL,
    ...
    "completed_at" timestamp with time zone,
    "result_id" "uuid",
    CONSTRAINT "ranked_game_sessions_question_codes_array" CHECK ((("question_codes" IS NULL) OR ("jsonb_typeof"("question_codes") = 'array'::"text"))),
    CONSTRAINT "ranked_game_sessions_question_count_positive" CHECK ((("question_count" IS NULL) OR ("question_count" > 0))),
    CONSTRAINT "ranked_game_sessions_status_valid" CHECK ((("status")::"text" = ANY (ARRAY['created'::"text", 'completed'::"text", 'expired'::"text", 'cancelled'::"text", 'rejected'::"text"])))
);
...
CREATE UNIQUE INDEX "idx_ranked_sessions_challenge_id" ON "private"."ranked_game_sessions" USING "btree" ("challenge_id") WHERE ("challenge_id" IS NOT NULL);



CREATE INDEX "idx_ranked_sessions_hash" ON "private"."ranked_game_sessions" USING "btree" ("session_nonce_hash");



CREATE UNIQUE INDEX "idx_ranked_sessions_promotion_idempotency" ON "private"."ranked_game_sessions" USING "btree" ("user_id", "promotion_idempotency_key") WHERE ("promotion_idempotency_key" IS NOT NULL);
...
ALTER TABLE ONLY "private"."ranked_game_sessions"
    ADD CONSTRAINT "ranked_game_sessions_challenge_id_fkey" FOREIGN KEY ("challenge_id") REFERENCES "public"."challenges"("id") ON DELETE SET NULL;



ALTER TABLE ONLY "private"."ranked_game_sessions"
    ADD CONSTRAINT "ranked_game_sessions_result_id_fkey" FOREIGN KEY ("result_id") REFERENCES "public"."game_results"("id") ON DELETE SET NULL;
...
REVOKE ALL ON FUNCTION "public"."create_challenge_from_ranked_session"("p_ranked_session_id" "uuid", "p_idemp_key" "text") FROM PUBLIC;
GRANT ALL ON FUNCTION "public"."create_challenge_from_ranked_session"("p_ranked_session_id" "uuid", "p_idemp_key" "text") TO "service_role";
GRANT ALL ON FUNCTION "public"."create_challenge_from_ranked_session"("p_ranked_session_id" "uuid", "p_idemp_key" "text") TO "authenticated";



REVOKE ALL ON FUNCTION "public"."create_ranked_session"("p_mode" "text", "p_variation" "text") FROM PUBLIC;
...
REVOKE ALL ON FUNCTION "public"."get_public_profile"("p_target_user_id" "uuid") FROM PUBLIC;
GRANT ALL ON FUNCTION "public"."get_public_profile"("p_target_user_id" "uuid") TO "service_role";
GRANT ALL ON FUNCTION "public"."get_public_profile"("p_target_user_id" "uuid") TO "authenticated";



REVOKE ALL ON FUNCTION "public"."get_supporter_profile_details"("p_target_user_id" "uuid") FROM PUBLIC;
GRANT ALL ON FUNCTION "public"."get_supporter_profile_details"("p_target_user_id" "uuid") TO "service_role";
GRANT ALL ON FUNCTION "public"."get_supporter_profile_details"("p_target_user_id" "uuid") TO "authenticated";
...
GRANT UPDATE("privacy_settings") ON TABLE "public"."profiles" TO "authenticated";
