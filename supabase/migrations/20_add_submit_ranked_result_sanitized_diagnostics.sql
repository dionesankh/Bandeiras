-- 20. Adicionar diagnostico sanitizado na submissao ranqueada
-- Mantem assinatura, retorno, SECURITY DEFINER, search_path seguro, auth.uid(),
-- validacoes, expiracao, nonce e grants. Nao altera interface nem JS.
